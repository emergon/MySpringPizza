...
@NamedQueries({
    ...
    , @NamedQuery(name = "Sizes.findBySname", query = "SELECT s FROM Sizes s WHERE s.sname = :sname")})
public class Sizes implements Serializable {
    ...
    public Sizes(Integer id, String sname) {
        this.id = id;
        this.sname = sname;
    }
    ...
    public String toString() {
        return "emergon.entity.Sizes[ id=" + id + " ]";
    }
